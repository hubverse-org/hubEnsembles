...
#'   to character. See details for how this changes the generated output type ID
#'   values. Defaults to NULL, in which case whether the output type ID column
#'   is numeric will be automatically detected.
#'
#' @details The resulting output type ID values are character strings by default,
#'   generated by a concatenation of the component model ID and initial
#'   output type ID. If `numeric_output_type_ids` = `TRUE`, a factor representation
#'   of this character string is coerced to a numeric value.
#' @noRd
#'
...
linear_pool_sample <- function(model_out_tbl, weights = NULL,
  ...
  model_out_tbl |>
    make_sample_indices_unique(numeric_output_type_ids) |>
...
#' @param numeric_output_type_ids `logical` specifying whether the output type ID
#'   columns should be numeric. See details for how this changes the generated
#'   output type ID values. Defaults to FALSE.
#'
#' @details The new output type ID values will follow one of two patterns:
