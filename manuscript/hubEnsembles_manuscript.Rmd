...
The target data provides the observed incident influenza hospitalizations (`value`) in a given week (`time_idx`) and location (`location`); this target data corresponds to the forecast target `wk inc flu hosp`. The forecast-specific task ID variables `reference_date` and `horizon` are not relevant.
