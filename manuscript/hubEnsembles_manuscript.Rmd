...
```{r scores-vs-forecast-date, message=FALSE, warning=FALSE, fig.cap='Average h-week ahead WIS, MAE, and 95% PI coverage by forecast date for each model for all locations (except the US national location), split by season for readability.', echo=FALSE}  
...
model_colors = brewer.pal(5,'Set2');
...
truth_states_2122 <- plot_flu_truth(flu_truth_all, date_range=flu_dates_21_22[c(1, 22)])
truth_states_2223 <- plot_flu_truth(flu_truth_all, date_range=flu_dates_22_23[c(1, 31)])
