...
```{r By date States WIS, message=FALSE, warning=FALSE, fig.cap='Average h-week ahead WIS for each model for the States national level.', echo=FALSE}  
...
```{r By date States MAE, message=FALSE, warning=FALSE, fig.cap='Average h-week ahead MAE for each model for the States national level.', echo=FALSE}  
# MAE
flu_date_horizon_season_states <- flu_scores_all |>
    evaluate_flu_scores(grouping_variables=c("horizon", "forecast_date", "season"), baseline_name="Flusight-baseline", us_only=FALSE)
...
```{r By date States 95 PI, message=FALSE, warning=FALSE, fig.cap='Average h-week ahead 95% PI coverage for each model for the States national level.', echo=FALSE}  
# 95% Coverage
...
<!-- LS: How much to include of location results which are only by WIS? -->
